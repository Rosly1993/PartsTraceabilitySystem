        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#items_table').DataTable({
                    "ajax": "<?php echo base_url('index.php/areas/get_areas'); ?>",
                    "columns": [
                        {
                            data: 'id',
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return '<a class="me-2 btn-sm editbtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="<?php echo base_url('index.php/areas/get_area_details/'); ?>"><i class="ni ni-settings"></i></a>' +
                ...
                $.post("<?php echo base_url('index.php/areas/add_area'); ?>", { areaName: areaName, locationName: locationName, userdata: userdata })
                    .done(function (data) {
